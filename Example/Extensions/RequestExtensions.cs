...
namespace Raydreams.API.Example.Extensions
{
    ...
    public static class RequestExtensions
    {
        ...
        /// <summary></summary>
        public static MethodVerb GetVerb(this HttpRequestData req) => req.Method.GetEnumValue<MethodVerb>(MethodVerb.GET, true);
        ...
        /// <summary>Parses an integer from a request query string</summary>
        /// <param name="key"></param>
        /// <param name="def">Default value to set to if the key DNE</param>
        /// <returns></returns>
        public static int GetIntValue(this HttpRequestData req, string key, int def = 0)
        {
            if (String.IsNullOrWhiteSpace(key))
                return def;
            ...
            return DataTypeConverter.GetIntValue(query[key].ToString());
        }
        ...
        /// <param name="def">Default value to set to if the key DNE</param>
        /// <returns></returns>
        public static float GetFloatValue(this HttpRequestData req, string key, float def = 0)
        {
            if (String.IsNullOrWhiteSpace(key))
                return def;
            ...
            return DataTypeConverter.GetFloatValue(query[key].ToString());
        }

        /// <summary>Just get all the params as a string,string dict</summary>
        /// <param name="req">The original HTTP request</param>
        /// <param name="delim">The char to use to spearate duplicate key values</param>
        /// <returns></returns>
        public static Dictionary<string, string> GetParams(this HttpRequestData req, char delim = ';')
        {
            ...
            foreach (string key in keys)
            {
                ...
                results.Add(key, String.Join(delim, values));
            }
